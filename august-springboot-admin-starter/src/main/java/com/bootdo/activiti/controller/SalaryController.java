...
public class SalaryController extends BaseController {
    ...
    String edit(@PathVariable("taskId") String taskId, Model model) {
        SalaryDO salary = salaryService.get(actTaskService.getBusinessKeyByTaskId(taskId));
    ...
    public R update(SalaryDO salary) {
        ...
        String taskKey = actTaskService.getTaskByTaskId(salary.getTaskId()).getTaskDefinitionKey();
