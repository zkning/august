        ...
        .bootstrapTable(
            {
                ...
                columns: [
                    ...
                    {
                        field: 'processDefinitionName', // 列字段名
                        title: '任务类型',// 列标题
                        formatter: function (value, row, index) {
                            return '<h3><span class="label label-info">' + value + '</span></h3>';
                        }
                    },
                    // {
                    //     field : 'id', // 列字段名
                    ...
                    },
                    {
                        ...
                        formatter: function (value, row, index) {
                            ...
                            var f = '<a class="btn btn-primary btn-sm " href="#" title="签收任务"  mce_href="#" onclick="form(\''
                                + row.processDefinitionKey + '\',\'' + row.key + '\',\'' + row.id + '\')">处理任务</a> ';
                            return f;
                        }
                    }]
            });
...
function form(proKey, taskKey, taskId) {
    layer.open({
        type: 2,
        title: '处理任务',
        // maxmin : true,
        shadeClose: false,
        area: ['80%', '80%'],
        content: prefix1 + '/handleWork/' + proKey + '/' + taskKey + '?taskId=' + taskId
    })
}
