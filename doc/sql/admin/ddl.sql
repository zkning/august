...
CREATE TABLE `t_sys_dict` (
  ...
  PRIMARY KEY (`id`),
  KEY `t_sys_dict_value` (`value`),
  KEY `t_sys_dict_label` (`name`),
  KEY `t_sys_dict_del_flag` (`del_flag`)
...
-- ----------------------------
-- Table structure for t_sys_track_record
-- ----------------------------
CREATE TABLE `t_sys_track_record` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=648 DEFAULT CHARSET=utf8 COMMENT='系统日志';
...
CREATE TABLE `t_sys_role_menu` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3652 DEFAULT CHARSET=utf8 COMMENT='角色与菜单对应关系';
...
CREATE TABLE `t_sys_track_record` (
  ...
  `gmt_create` datetime DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9582 DEFAULT CHARSET=utf8 COMMENT='系统日志';